...
# Dataset
DATA_DIR = 'E:/Angel/Development/Datasets/Anime_faces_256' #'<your dataset path>' # Path to the dataset
...
MARGIN = IMAGE_SIZE // 8
MA_BETA = 0.5 ** (BATCH_SIZE / (MA_HALF_LIFE * 1000.0)) if MA_HALF_LIFE > 0.0 else 0.0
